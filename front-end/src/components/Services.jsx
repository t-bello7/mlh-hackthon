...
const Services = () => {
  return (
    <div className='p-5 pb-10 md:flex justify-center pt-10 md:mt-10'>
        <div>
            <div>
            ...
            <div className='md:flex md:mt-6 items-center'>
                <div className='mt-6 w-full flex justify-center md:w-[400px]'>
                ...
                <div className='mt-4'>
                    ...
                    <div className='mt-4 bg-gray-900 p-7 rounded-lg w-full md:w-[400px]'>
